...
const saladsen = require("../data/languages/saladsen.json")
const saladsru = require("../data/languages/saladsru.json")
...
export const setI18nConfigSalads = () => {
...
export const dataRecipeSalads = () => {

    let loadedRecipes = []
    try {

        let resData = JSON.parse(JSON.stringify(saladsen));
