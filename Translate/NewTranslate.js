...
const newmealen = require('../data/languages/newmealen.json');
const newmealru = require("../data/languages/newmealru.json");
...
export const dataNewRecipe = () => {

    let loadedRecipes = []
    try {

        let resData = JSON.parse(JSON.stringify(newmealen));
